...
def process_song_data(spark, input_data, output_data):
    '''
    function that process the song_data files and creates two tables
    - songs_table
    - artist_table
    '''
    # get filepath to song data file
    #********************LIMITED*************
    # only loading partial dataset b/c of time constraints.
    
    # full dataset
    song_data_full = os.path.join(input_data, 'song_data/*/*/*/*.json')
...
def process_log_data(spark, input_data, output_data):
    '''
    function that process log_data files and creates tables:
    - artists_table
    - timestamp_table
    - songplays_table
    '''
...
def main():
    ...
    declares s3 bucket locations
    '''
    spark = create_spark_session()
    input_data = "s3a://udacity-dend/"
    output_data = "s3a://salas-bucket/data-lake/"
